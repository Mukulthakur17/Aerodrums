...
def Playsound(instr):
    if instr == 1:
        playsound('utils/DrumSnare.wav')
    elif instr == 2:
        playsound('utils/DrumHeavySnare.wav')
    elif instr == 3:
        playsound('utils/DrumNoiseClap.wav')
    elif instr == 4:
        playsound('utils/DrumCymbal.wav')
    elif instr == 5:
        playsound('utils/DrumHiHat.wav')
